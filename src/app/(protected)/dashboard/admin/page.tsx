    ...
    <div className="space-y-8 font-sans selection:bg-cyan-500/30 pb-20">
      ...
      <div className="bg-[#0a0a0c] border border-zinc-800 rounded-2xl p-6 flex flex-col md:flex-row justify-between items-center gap-8 shadow-lg">
        <div className="flex items-center gap-6">
          <div className="relative flex items-center justify-center w-24 h-24 rounded-full border-4 border-emerald-500/20 bg-emerald-950/10">
            <div className="text-3xl font-bold text-zinc-100">92</div>
            <svg className="absolute inset-0 w-full h-full -rotate-90">
              <circle 
                cx="44" 
                cy="44" 
                r="44" 
                className="stroke-emerald-400 fill-none stroke-[4] stroke-dasharray-[276] stroke-dashoffset-[22]" 
          ...
          <div>
            ...
            <div className="text-xs font-mono text-emerald-400 tracking-wider mt-1 flex items-center gap-1.5">
              ...
              EXCELLENT • ZERO THREATS DETECTED
            </div>
            <p className="text-xs text-zinc-400 mt-1">
              All identity checks and encryption modules are functioning normally.
            </p>
          </div>
        </div>
        
        {/* Sub-systems Health with Simple Plain English */}
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-x-6 gap-y-4 text-center">
          <div className="flex flex-col items-center gap-1.5 p-2 rounded-lg bg-zinc-900/30 border border-zinc-800/40">
          ...
          <div className="flex flex-col items-center gap-1.5 p-2 rounded-lg bg-zinc-900/30 border border-zinc-800/40">
            ...
            <span className="text-[11px] font-semibold text-zinc-200">Auto Scanner</span>
      ...
      {/* Detailed Stats with Simple Explanations */}
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card className="bg-[#0a0a0c] border-zinc-800 rounded-xl">
          ...
          <CardContent className="px-4 pb-4">
            <div className="text-3xl font-bold text-zinc-100">{result.data?.totalUsers}</div>
        ...
        <Card className="bg-[#0a0a0c] border-zinc-800 rounded-xl">
          ...
          <CardContent className="px-4 pb-4">
            <div className="text-3xl font-bold text-zinc-100">{result.data?.activeAssets}</div>
        ...
        <Card className="bg-[#0a0a0c] border-zinc-800 rounded-xl">
          ...
          <CardContent className="px-4 pb-4">
            <div className="text-3xl font-bold text-zinc-100">{result.data?.pendingAccessRequests}</div>
      ...
      {/* Activity Logs & Security Scanner with Plain English */}
        ...
        <Card className="bg-[#0a0a0c] border-zinc-800 rounded-2xl">
          <CardHeader className="pb-4 border-b border-zinc-800/80">
            <CardTitle className="text-sm font-semibold text-zinc-200 flex items-center gap-2">
              ...
              Sentinel Automated Security Guard
            </CardTitle>
          </CardHeader>
            ...
            <div className="space-y-5">
              <div className="space-y-3 text-xs">
                ...
                <div className="flex justify-between items-center pb-2.5 border-b border-zinc-800/50">
                  ...
                  <span className="text-cyan-400 font-mono font-semibold">5 / 5 Passed Cleanly</span>
                </div>
                <div className="flex justify-between items-center pb-2.5 border-b border-zinc-800/50">
                ...
                <div className="flex justify-between items-center">
                  <span className="text-zinc-400">Threat Containment Action</span>
                  <span className="text-zinc-300 font-mono">Instant Auto-Lockdown</span>
                </div>
              </div>

              <div className="p-3.5 rounded-xl bg-cyan-950/20 border border-cyan-500/20 text-xs text-zinc-300 leading-relaxed font-light">
                💡 <strong>Judge Note</strong>: The Sentinel engine continuously monitors every access attempt. If an unauthorized user or untrusted device tries to decrypt a file, access is immediately blocked and logged to the tamper-proof ledger.
              </div>
            </div>
          </CardContent>
        </Card>
